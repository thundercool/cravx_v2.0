...
<link rel="apple-touch-icon" href="../../resources/img/icon152.png"
	sizes="152x152">
<link rel="apple-touch-icon" href="../../resources/img/icon180.png"
	sizes="180x180">
				...
				<div id="sidebar-scroll">
					...
					<div class="sidebar-content">
						...
						<a href="index.html" class="sidebar-brand"> <i
							class="gi gi-flash"></i><span class="sidebar-nav-mini-hide"><strong>Super</strong>Admin</span>
						</a>
						<!-- END Brand -->
						...
						<ul class="sidebar-nav">
							...
							<li><a href="#" class="sidebar-nav-menu"><i
									class="fa fa-plus sidebar-nav-indicator sidebar-nav-mini-hide"></i><i
									class="gi gi-shopping_cart sidebar-nav-icon"></i><span
									class="sidebar-nav-mini-hide">Card </span></a>
								<ul>
									<li><a href="page_ecom_dashboard.html">Generate Cards</a>
									</li>
									<li><a href="page_ecom_orders.html">Assign Cards</a></li>
									<!--  <li>
							...
							<li><a href="#" class="sidebar-nav-menu"><i
									...
									class="sidebar-nav-mini-hide">Masters </span></a>
								<ul>
									...
									<li><a href="page_ui_draggable_blocks.html">Draggable
											Blocks</a></li>
									...
									<li><a href="page_ui_navigation_more.html">Navigation
											&amp; More</a></li>
									<li><a href="page_ui_horizontal_menu.html">Horizontal
											Menu</a></li>
									<li><a href="page_ui_progress_loading.html">Progress
											&amp; Loading</a></li>
									<li><a href="page_ui_preloader.html">Page Preloader</a></li>
									<li><a href="page_ui_color_themes.html">Color Themes</a></li>
								</ul></li>
			...
			<div id="main-container">
				...
				<div id="page-content">
					...
					<div class="block">
						...
						<div class="block-title">
							<h2>
								<strong>Form Validation</strong> Example
							</h2>
						</div>
						...
						<form id="form-validation"
							action="/ManageLocation/CityList/SaveCity"
							 method="post"
							class="form-horizontal form-bordered" novalidate="novalidate">
							<fieldset>
								<legend>
									<i class="fa fa-angle-right"></i> Vital Info
								</legend>
								<div class="form-group">
									<label class="col-md-4 control-label" for="val_username">City
										Name <span class="text-danger">*</span>
									</label>
									<div class="col-md-6">
										<div class="input-group">
											<input type="text" id="firstname" name="cityName"
												class="form-control" />
										</div>
									</div>
								</div>
								  ...
								  <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select id="example-chosen" name="chosenStateId" class="select-chosen" data-placeholder="Choose a Country.." style="width: 250px; display: none;">
                                                      <option value="">Select State</option>	
													<c:forEach items="${stateList}" var="state">
													<option value="${state.stateId}"
														<c:if test="${city.state.stateId eq state.stateId}">selected="selected"</c:if>>${state.stateName}</option>
												   </c:forEach>                                                      
												   </select>
                                                </div>
                                            </div>
								...
								<div class="form-group form-actions">
									<div class="col-md-9 col-md-offset-3">
										...
										<a class="btn btn-sm btn-primary" href="/ManageLocation/CityList"><i
											class="gi gi-remove"></i> Cancel</a>
									</div>
								</div>
				...
				<footer class="clearfix">
					<div class="pull-right">
						CravX <i class="fa fa-heart text-danger"></i> by <a
							href="http://goo.gl/vNS3I" target="_blank">Foodies</a>
					</div>
					<div class="pull-left">
