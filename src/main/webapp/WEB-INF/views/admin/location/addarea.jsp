                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <ul class="sidebar-nav">
                            <li>
                                <a href="/Welcome" class=" active"><i class="gi gi-stopwatch sidebar-nav-icon"></i><span
...
<form id="form-validation"
							action="/ManageLocation/AreaList/SaveArea"
							 method="post"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="val_username">Area
										Name <span class="text-danger">*</span>
									</label>
									<div class="col-md-6">
										<div class="input-group">
											<input type="text" id="firstname" name="areaName"
												class="form-control" />
										</div>
									</div>
								</div>
								  ...
								  <div class="form-group">
                                                <label class="col-md-4 control-label" for="example-chosen">Select Select</label>
                                                <div class="col-md-6">
                                             ...
                                             <div class="form-group">
                                                <label class="col-md-4 control-label" for="example-chosen">Select City</label>
                                                <div class="col-md-6">
                                                    <select id="cityId" name="chosenCityId" class="select-chosen" data-placeholder="Choose a City.." style="width: 250px;">
                                                      <option value="">Select City</option>	
                                                    <%--   <c:forEach items="${cityList}" var="city">
													<option value="${city.cityId}"
														<c:if test="${area.city.cityId eq city.cityId}">selected="selected"</c:if>>${city.cityName}</option>
												   </c:forEach>   --%>
												   </select>
                                                </div>
                                            </div>
								...
								<div class="form-group form-actions">
									<div class="col-md-9 col-md-offset-3">
										...
										<a class="btn btn-sm btn-primary" href="/ManageLocation/AreaList"><i
