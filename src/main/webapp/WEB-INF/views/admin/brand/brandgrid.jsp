            ...
            <div id="main-container">
                ...
                <strong>Success!</strong> Brand created Successfully!!!!!
                  ...
                  <!-- Inline Form Block -->
						...
						<a class="btn btn-sm btn-primary" href="/ManageBrand/BrandList/AddBrand"> <i class="fa fa-angle-right"></i> Add Brand</a>
						<!-- END Form Validation Example Title -->
                               ...
                               <div class="table-responsive">
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="brand" items="${barndList}" varStatus="count">
                                        <tr>
                                            <td class="text-center">${count.count}</td>
                                            <td class="text-center">${brand.brandName} </td>
                                            <td class="text-center">${brand.company.companyName} </td>
                                            <td class="text-center">${brand.brandAdmin.firstName}</td>
                                            <td class="text-center">${brand.brandAdmin.loginId}</td>
