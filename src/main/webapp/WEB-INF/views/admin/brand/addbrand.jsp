    ...
    <div id="page-wrapper">
          <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
             <div id="sidebar">
                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <!-- brandAdmin Info -->
                        <div class="sidebar-section sidebar-brandAdmin clearfix sidebar-nav-mini-hide">
                            <div class="sidebar-brandAdmin-avatar">
                                <a href="page_ready_brandAdmin_profile.html">
                                    <img src="../../resources/img/placeholders/avatars/avatar2.jpg" alt="avatar">
                                </a>
                            </div>
                            <div class="sidebar-brandAdmin-name">${brandAdmin.loginId}</div>
                            <div class="sidebar-brandAdmin-links">
                                <a href="page_ready_brandAdmin_profile.html" data-toggle="tooltip" data-placement="bottom"
                                    title="Profile"><i class="gi gi-brandAdmin"></i></a>
            ...
            <div id="main-container">
                ...
                <strong>Success!</strong> brandAdmin created Successfully!!!!!
                </div>
                </c:if>
                  <!-- Inline Form Block -->
                             <div class="block">
...
<form action="/ManageBrand/BrandList/SaveBrand" method="post" class="form-horizontal ui-formwizard"
			...
			<div class="col-md-6">
				<div class="block">
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="brand_Name">Brand Name <span class="text-danger">*</span>
						</label>
						<div class="col-md-6">

							<input id="brand_Name" name="brandName" class="form-control"
								placeholder="brand Name"
								type="text" value="${brand.brandName}">
						</div>
					</div>
					
					<div class="form-group" id="companyDiv">
						<label class="col-md-4 control-label" for="chosenCompanyId">Company<span class="text-danger">*</span></label>
						<div class="col-md-6">
							<select class="select-chosen" style="width: 200px;"
								id="chosenCompanyId"
								data-placeholder="Choose Company.."
								name="chosenCompanyId">
								<option value=""></option>
						...
						<div class="col-md-8">
							<div class="input-group input-daterange "
								...
								<input type="text" id="compAgreementStart"
									...
									placeholder="From" value="${brand.compAgreementStart}"> <span class="input-group-addon"><i
									class="fa fa-angle-right"></i></span> <input type="text"
									id="compAgreementEnd" name="compAgreementEnd"
									class="form-control text-center" placeholder="To" value="${brand.compAgreementEnd}">
							</div>
						</div>
					</div>
					<div class="form-group">
				...
				<div class="block">  
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<input id="brandTelephone1" name="brandTelephone"
								class="form-control"
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="rest_email">brand Email Id<span class="text-danger">*</span></label>
						<div class="col-md-6">
				...
				<%-- 	<div class="form-group">
						...
						<div class="col-md-6">
							<select class="select-chosen" style="width: 200px;"
								...
								<c:forEach items="${stateList}" var="state">
											...
											<c:if test="${state.stateId eq brand.brandState.stateId}">selected="selected"</c:if>>${state.stateName}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="brandPincode">Pincode<span class="text-danger">*</span></label>
						<div class="col-md-6">
				...
				<div class="block">
					<div class="block-title">
						<h2>
							...
							<small style="float:left; margin-top: 4px;">brand Login Info</small>
						</h2>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<input id="first_Name" name="firstName" class="form-control"
								...
								type="text" value="${brand.brandAdmin.firstName}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<input id="last_Name" name="lastName" class="form-control"
								...
								type="text" value="${brand.brandAdmin.lastName}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input id="mobile" name="mobile" class="form-control" 
								placeholder="Mobile No" type="text" value="${brand.brandAdmin.mobile}"/>
						</div>
					</div>
						...
						<div class="col-md-6">
							<div class="input-group">
								<input id="login" name="loginId" class="form-control col-md-4 "
									placeholder='Login Id' type="text" value="${brand.brandAdmin.loginId}">
							</div>
						</div>
					</div>
		...
		<div class="form-group form-actions">
				<div class="col-md-9 col-md-offset-3">
					<button id="brand_submit" type="submit"
						...
						<a class="btn btn-sm btn-primary save" href="/ManageBrand/BrandList"><i class="gi gi-remove"></i>
							Cancel </a>
				</div>
			</div>
	</form>
    ...
    <!-- brandAdmin Settings, modal which opens from Settings link (found in top right brandAdmin menu) and the Cog link (found in sidebar brandAdmin info) -->
    <div id="modal-brandAdmin-settings" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="index.html" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">brandAdminname</label>
                                <div class="col-md-8">
                                    <p class="form-control-static">Admin</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="brandAdmin-settings-email">Email</label>
                                <div class="col-md-8">
                                    <input type="email" id="brandAdmin-settings-email" name="brandAdmin-settings-email" class="form-control"
                                        value="admin@example.com">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="brandAdmin-settings-notifications">Email
                                    Notifications</label>
                                <div class="col-md-8">
                                    <label class="switch switch-primary">
                                        <input type="checkbox" id="brandAdmin-settings-notifications" name="brandAdmin-settings-notifications"
                                            value="1" checked>
                                        <span></span>
                                    </label>
                                </div>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="brandAdmin-settings-password">New Password</label>
                                <div class="col-md-8">
                                    <input type="password" id="brandAdmin-settings-password" name="brandAdmin-settings-password"
                                        class="form-control" placeholder="Please choose a complex one..">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="brandAdmin-settings-repassword">Confirm New
                                    Password</label>
                                <div class="col-md-8">
                                    <input type="password" id="brandAdmin-settings-repassword" name="brandAdmin-settings-repassword"
