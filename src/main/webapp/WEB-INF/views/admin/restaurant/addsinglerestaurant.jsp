        ...
        <div id="page-wrapper">
          <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
            ...
            <div id="main-container">
                ...
                <strong>Success!</strong> outletAdmin created Successfully!!!!!
                </div>
                </c:if>
                  <!-- Inline Form Block -->
                             <div class="block">
...
<form action="/ManageRestaurant/RestaurantList/SaveSingleRestaurant" method="post" class="form-horizontal ui-formwizard"
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="block">
					<div class="block-title">
						<h2>
							<strong>outlet Info</strong>
						</h2>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label" for="outlet_Name">Restaurant Name <span class="text-danger">*</span>
						</label>
						<div class="col-md-6">

							<input id="outlet_Name" name="outletName" class="form-control"
								placeholder="outlet Name"
								type="text" value="${outlet.outletName}">
						</div>
					</div>
						...
						<div class="col-md-6">
							<select class="select-chosen" style="width: 200px;"
								...
								<c:forEach items="${companyList}" var="company">
									<option value="${company.companyId}"  <c:if test="${company.companyId eq outlet.company.companyId}">selected="selected"</c:if> >${company.companyName}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group" id="companyDiv">
						<label class="col-md-4 control-label" for="chosenCompanyId">Brand<span class="text-danger">*</span></label>
						<div class="col-md-6">
							<select class="select-chosen" style="width: 200px;"
								id="chosenBrandId"
						...
						<div class="col-md-8">
							<div class="input-group input-daterange "
								...
								<input type="text" id="compAgreementStart"
									name="outletAgreementStart" class="form-control text-center"
									placeholder="From" value="${outlet.restAgreementStart}"> <span class="input-group-addon"><i
									class="fa fa-angle-right"></i></span> <input type="text"
									id="compAgreementEnd" name="outletAgreementEnd"
									class="form-control text-center" placeholder="To" value="${outlet.restAgreementEnd}">
							</div>
						</div>
					</div>
					<div class="form-group">
				...
				<div class="block">  
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<input id="outletTelephone1" name="outletTelephone"
								class="form-control"
								placeholder="Telephone"
								type="text" value="${outlet.outletTelephone}" >
						</div>
					</div>


					<div class="form-group">
						<label class="col-md-4 control-label" for="rest_email">outlet Email Id<span class="text-danger">*</span></label>
						<div class="col-md-6">

							<input id="outlet_email" name="outletEmail"
								class="form-control"
								placeholder="outlet Email Id"
								type="text" value="${outlet.outletEmail}">
						</div>
					</div>
				...
				<%-- 	<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<input id="outletAddressline1" name="outletAddressLine1"
								class="form-control"
								placeholder="Address Line 1"
								type="text" value="${outlet.outletAddressLine1}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<input id="outletAddressline2" name="outletAddressLine2"
								class="form-control"
								placeholder="Address Line 2"
								type="text" value="${outlet.outletAddressLine2}">
						</div>
					</div>
						...
						<div class="col-md-6">
							<select class="select-chosen" style="width: 200px;"
								...
								<c:forEach items="${stateList}" var="state">
											...
											<c:if test="${state.stateId eq outlet.outletState.stateId}">selected="selected"</c:if>>${state.stateName}</option>
								</c:forEach>
							</select>
						</div>
					</div>
						...
						<div class="col-md-6">
							<select class="select-chosen" style="width: 200px;"
								...
								<c:forEach items="${cityList}" var="city">
									<option value="${city.cityId}"  <c:if test="${city.cityId eq outlet.outletCity.cityId}">selected="selected"</c:if> >${city.cityName}</option>
								</c:forEach>
							</select>
						</div>
					</div>
						...
						<div class="col-md-6">
							<select class="select-chosen" style="width: 200px;"
								...
								<c:forEach items="${areaList}" var="area">
												<option value="${area.areaId}"  <c:if test="${area.areaId eq outlet.outletArea.areaId}">selected="selected"</c:if> >${area.areaName}</option>
									</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="outletPincode">Pincode<span class="text-danger">*</span></label>
						<div class="col-md-6">

							<input id="outletPincode" name="outletPincode"
								class="form-control"
								placeholder="Pincode"
								type="text" value="${outlet.outletPincode}">
						</div>
					</div>
				</div> 
			</div>
				...
				<div class="block">
					<div class="block-title">
						<h2>
							...
							<small style="float:left; margin-top: 4px;">outlet Login Info</small>
						</h2>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<input id="first_Name" name="firstName" class="form-control"
								...
								type="text" value="${outlet.outletAdmin.firstName}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<input id="last_Name" name="lastName" class="form-control"
								...
								type="text" value="${outlet.outletAdmin.lastName}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input id="email" name="emailId" class="form-control" 
								placeholder="test@example.com" type="text" value="${outlet.outletAdmin.emailId}"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input id="mobile" name="mobile" class="form-control" 
								placeholder="Mobile No" type="text" value="${outlet.outletAdmin.mobile}"/>
						</div>
					</div>
						...
						<div class="col-md-6">
							<div class="input-group">
								<input id="login" name="loginId" class="form-control col-md-4 "
									placeholder='Login Id' type="text" value="${outlet.outletAdmin.loginId}">
							</div>
						</div>
					</div>
		...
		<div class="form-group form-actions">
				<div class="col-md-9 col-md-offset-3">
					<button id="outlet_submit" type="submit"
						...
						<a class="btn btn-sm btn-primary save" href="/ManageRestaurant/RestaurantList"><i class="gi gi-remove"></i>
							Cancel </a>
				</div>
			</div>
	</form>
