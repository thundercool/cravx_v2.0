    ...
    <div id="page-wrapper">
          <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
            ...
            <div id="main-container">
                ...
                <strong>Success!</strong>${cardCount} Card Generated Successfully!!!!!
                </div>
                </c:if>
                  <!-- Inline Form Block -->
                                <div class="block full">
                                    ...
                                    <div class="block-title">
                                        <h2><strong>Generate</strong> Card</h2>
                                    </div>
                                    <!-- END Inline Form Title -->

                                    <!-- Inline Form Content -->
                                    <form action="/ManageCard/Card/GenerateCard" method="post" class="form-inline">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary"><i class="fa fa-user"></i> Generate</button>
