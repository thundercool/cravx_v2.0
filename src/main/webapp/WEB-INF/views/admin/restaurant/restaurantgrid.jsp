    ...
    <div id="page-wrapper">
          <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
            ...
            <div id="main-container">
                ...
                <strong>Success!</strong> Restaurant created Successfully!!!!!
                </div>
                </c:if>
                  <!-- Inline Form Block -->
                             <div class="block">
						...
						<a class="btn btn-sm btn-primary" href="/ManageRestaurant/RestaurantList/AddRestaurant"> <i class="fa fa-angle-right"></i> Add Restaurant</a>
						<a class="btn btn-sm btn-primary" href="/ManageRestaurant/RestaurantList/AddSingleRestaurant"> <i class="fa fa-angle-right"></i> Add Single Restaurant</a>
						...
						<!-- END Form Validation Example Title -->
                               ...
                               <div class="table-responsive">
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="restaurant" items="${restaurantList}" varStatus="count">
                                        <tr>
                                            <td class="text-center">${count.count}</td>
                                            <td class="text-center">${restaurant.outletName} </td>
                                            <td class="text-center">${restaurant.company.companyName} </td>
                                            <td class="text-center">${restaurant.brand.brandName} </td>
                                            <td class="text-center">${restaurant.outletAdmin.firstName}</td>
                                            <td class="text-center">${restaurant.outletAdmin.loginId}</td>
