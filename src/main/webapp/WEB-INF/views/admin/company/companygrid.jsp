            ...
            <div id="main-container">
                ...
                <strong>Success!</strong> company created Successfully!!!!!
                  ...
                  <!-- Inline Form Block -->
						...
						<a class="btn btn-sm btn-primary" href="/ManageCompany/CompanyList/AddCompany"> <i class="fa fa-angle-right"></i> Add company</a>
						<!-- END Form Validation Example Title -->
                               ...
                               <div class="table-responsive">
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="company" items="${companyList}" varStatus="count">
                                        <tr>
                                            <td class="text-center">${count.count}</td>
                                            <td class="text-center">${company.companyName} </td>
                                            <td class="text-center">${company.companyAdmin.firstName}</td>
                                            <td class="text-center">${company.companyAdmin.loginId}</td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="/ManageCompany/CompanyList/EditCompany?id=${company.companyId}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
