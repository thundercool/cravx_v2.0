    ...
    <div id="page-wrapper">
          <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
            ...
            <div id="main-container">
                ...
                <strong>Success!</strong> State created Successfully!!!!!
                </div>
                </c:if>
                  <!-- Inline Form Block -->
                             <div class="block">
						...
						<a class="btn btn-sm btn-primary" href="/ManageLocation/StateList/AddState"> <i class="fa fa-angle-right"></i> Add State</a>
						<!-- END Form Validation Example Title -->
                               ...
                               <div class="table-responsive">
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="state" items="${activeStateList}" varStatus="count">
                                        <tr>
