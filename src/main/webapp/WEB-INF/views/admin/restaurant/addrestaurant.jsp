...
<form action="/ManageRestaurant/RestaurantList/SaveRestaurant" method="post" class="form-horizontal ui-formwizard"
			...
			<div class="col-md-6">
				<div class="block">
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="outlet_Name">Outlet Name <span class="text-danger">*</span>
						</label>
						<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<input id="outletTelephone1" name="outletTelephone"
								...
								type="text" value="${outlet.outletTelephone1}" >
						</div>
					</div>
