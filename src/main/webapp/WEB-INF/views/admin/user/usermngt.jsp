            ...
            <div id="main-container">
                ...
                <strong>Success!</strong> User created Successfully!!!!!
                  ...
                  <!-- Inline Form Block -->
						...
						<a class="btn btn-sm btn-primary" href="/User/UserList/AddUser"> <i class="fa fa-angle-right"></i> Add User</a>
						<!-- END Form Validation Example Title -->
                               ...
                               <div class="table-responsive">
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="userObj" items="${activeUserList}" varStatus="count">
                                        <tr>
                                            <td class="text-center">${count.count}</td>
                                            <td class="text-center">${userObj.firstName} ${userObj.lastName}</td>
                                            <td class="text-center">${userObj.mobile}</td>
                                            <td>${userObj.emailId}</td>
                                            <td>${userObj.loginId}</td>
