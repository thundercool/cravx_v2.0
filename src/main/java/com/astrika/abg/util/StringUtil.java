...
//import com.astrika.kernel.io.unsync.UnsyncBufferedReader;
//import com.astrika.kernel.io.unsync.UnsyncStringReader;
...
//	}
	...
	public static StringBuffer replaceWithStringBuffer(
		String s, String begin, String end, Map<String, StringBuffer> values) {
...
//		for (StringBuffer valueSB : values.values()) {
//			size += valueSB.index();
//		}
		...
		while (true) {
			...
			if ((x == -1) || (y == -1)) {
				...
				StringBuffer newValue = values.get(oldValue);
