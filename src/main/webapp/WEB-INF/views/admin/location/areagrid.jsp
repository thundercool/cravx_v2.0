    ...
    <div id="page-wrapper">
          <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
            ...
            <div id="main-container">
                ...
                <strong>Success!</strong> Area created Successfully!!!!!
                </div>
                </c:if>
                  <!-- Inline Form Block -->
                             <div class="block">
						...
						<a class="btn btn-sm btn-primary" href="/ManageLocation/AreaList/AddArea"> <i class="fa fa-angle-right"></i> Add Area</a>
						<!-- END Form Validation Example Title -->
                               ...
                               <div class="table-responsive">
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="area" items="${activeAreaList}" varStatus="count">
                                        <tr>
                                            <td class="text-center">${count.count}</td>
                                            <td class="text-center">${area.areaName} </td>
                                            <td class="text-center">${area.city.cityName}</td>
                                            <td class="text-center">${area.state.stateName}</td>
