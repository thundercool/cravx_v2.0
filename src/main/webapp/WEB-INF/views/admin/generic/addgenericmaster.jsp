					...
					<div class="sidebar-content">
						...
						<ul class="sidebar-nav">
							...
							<li><a href="#" class="sidebar-nav-menu"><i
								...
								<ul>
									<li><a href="/ManageCard/Card/AddCard">Add Cards</a></li>
									<li><a href="/ManageCard/Card/AssignCard">Assign Cards</a>
									</li>
								</ul></li>
							...
							<li><a href="#" class="sidebar-nav-menu"><i
								...
								<ul>
									...
									<li><a href="/ManageRestaurant/RestaurantList">Restaurant
											List</a></li>
								</ul></li>
			...
			<div id="main-container">
				...
				<div id="page-content">
					...
					<div class="block">
						...
						<form action="/ManageGeneric/SaveGeneric"
							method="post" class="form-horizontal form-bordered"
							id="generic_form" modelAttribute="generic">
							<div class="form-group">
<%-- 								<form:input path='id' type="hidden" />
 --%>								<label class="col-md-3 control-label" for="generic_Name">Name<span class="text-danger">*</span></label>
								<div class="col-md-9">
							...
							<div class="form-group" id="cityDiv">
								<label class="col-md-3 control-label" for="genericType_Name">Generic Type <span class="text-danger">*</span></label>
								<div class="col-md-9">
									<select name="genericMasterType"
							...
							<div class="form-group form-actions">
								<div class="col-md-9 col-md-offset-3">
									...
									<a class="btn btn-sm btn-primary" id="cancel"
										href="/ManageGeneric/Generic"> <i
										class="gi gi-remove"></i> Cancel
									</a>
								</div>
							</div>
						</form>
    ...
    function changeState(stateId){
		$.ajax({
			...
			success: function(data, textStatus, jqXHR){
				...
				$("#cityId").html(myOptions).chosen().trigger("chosen:updated");
			},
			dataType: 'html'
		});
	}
