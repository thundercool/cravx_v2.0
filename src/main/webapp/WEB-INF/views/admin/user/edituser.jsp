                ...
                <strong>Success!</strong> User Updated Successfully!!!!!
                  ...
                  <!-- Inline Form Block -->
                             <div class="block">
                                    ...
                                    <form:form id="form-validation" action="page_forms_validation.html" modelAttribute="objUser" method="post" class="form-horizontal form-bordered" novalidate="novalidate">
                                        <fieldset>
