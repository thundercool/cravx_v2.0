			...
			<div id="main-container">
				...
				<div id="page-content">
					...
					<div class="block">
						...
						<form:form id="form-validation"
							action="/ManageLocation/StateList/SaveState"
							modelAttribute="state" method="post"
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="val_username">State
										Name <span class="text-danger">*</span>
									</label>
									<div class="col-md-6">
										<div class="input-group">
											<form:input type="text" id="firstname" path="stateName"
												class="form-control" />
										</div>
									</div>
								</div>
								...
								<div class="form-group form-actions">
									<div class="col-md-9 col-md-offset-3">
										...
										<a class="btn btn-sm btn-primary" href="/User/UserList"><i
